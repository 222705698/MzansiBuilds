...
export default function Register() {
  ...
  const [form, setForm] = useState({
    username: "", email: "", password: "", bio: "", github_url: "", skills: ""
  })
      ...
      <div className="w-full max-w-md border border-gray-200 rounded-xl p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <input name="password" type="password" placeholder="Password" onChange={handleChange}
            className="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:border-green-500" required />
          <input name="bio" placeholder="Bio (optional)" onChange={handleChange}
            className="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:border-green-500" />
          <input name="github_url" placeholder="GitHub URL (optional)" onChange={handleChange}
            className="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:border-green-500" />
          <input name="skills" placeholder="Skills (e.g. React, Node.js)" onChange={handleChange}
            className="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:border-green-500" />
